...
def main(result_dir):
    ...
    y = sn.ops.softmax_classification_output(logits)
    acc = sn.ops.classification_accuracy(y, input_y)
    ...
    (x_train, y_train), (x_test, y_test) = \
        sn.datasets.load_cifar10(x_shape=(config.x_dim,), normalize_x=True)
