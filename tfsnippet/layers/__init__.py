...
__all__ = [
    ...
    'dense', 'get_deconv_output_length', 'get_variable_ddi',
    'global_avg_pool2d', 'is_log_det_shape_matches_input', 'l2_regularizer',
    'max_pool2d', 'planar_normalizing_flows', 'resnet_conv2d_block',
