...
__all__ = [
    ...
    'config_defaults', 'create_session', 'deprecated', 'deprecated_arg',
    'ensure_variables_initialized', 'flatten_to_ndims', 'get_batch_size',
    'get_cache_root', 'get_config_validator', 'get_default_scope_name',
    ...
    'minibatch_slices_iterator', 'register_config_arguments',
    ...
    'set_check_numerics', 'set_random_seed', 'should_check_numerics',
